  ...
  Widget _buildFullScreenVideo(
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        onVerticalDragEnd: (details) => widget.controller.fullscreenOnGesture != null
            ? widget.controller.fullscreenOnGesture!(widget.controller, details.velocity.pixelsPerSecond.dy > 0)
            : null,
        child: Container(
